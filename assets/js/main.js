...
var _user$project$Components_Atoms_Button$buttonStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Components_Atoms_Button$button = F2(
	function (attributes, contents) {
		return A2(
			_elm_lang$html$Html$button,
			{ctor: '::', _0: _user$project$Components_Atoms_Button$buttonStyle, _1: attributes},
			contents);
	});

var _user$project$Modules_User$initialModel = function (socketUrl) {
	return {email: '', password: '', passwordConfirmation: '', isLoggedIn: false, socketUrl: socketUrl};
};
var _user$project$Modules_User$Model = F5(
	function (a, b, c, d, e) {
		return {email: a, password: b, passwordConfirmation: c, isLoggedIn: d, socketUrl: e};
	});
var _user$project$Modules_User$NoOp = {ctor: 'NoOp'};
var _user$project$Modules_User$RegisterError = function (a) {
	return {ctor: 'RegisterError', _0: a};
};
var _user$project$Modules_User$RegisterSuccess = function (a) {
	return {ctor: 'RegisterSuccess', _0: a};
};
var _user$project$Modules_User$register = F3(
	function (socketUrl, email, password) {
		...
		var push = A2(
			...
			_user$project$Modules_User$RegisterError,
			A2(
				_saschatimme$elm_phoenix$Phoenix_Push$onOk,
				_user$project$Modules_User$RegisterSuccess,
				A2(
...
var _user$project$Modules_User$LoginError = function (a) {
	return {ctor: 'LoginError', _0: a};
};
var _user$project$Modules_User$LoginSuccess = function (a) {
	return {ctor: 'LoginSuccess', _0: a};
};
var _user$project$Modules_User$login = F3(
	function (socketUrl, email, password) {
		var payload = _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
		...
		var push = A2(
			_saschatimme$elm_phoenix$Phoenix_Push$onError,
			_user$project$Modules_User$LoginError,
			A2(
				_saschatimme$elm_phoenix$Phoenix_Push$onOk,
				_user$project$Modules_User$LoginSuccess,
				A2(
					_saschatimme$elm_phoenix$Phoenix_Push$withPayload,
					payload,
...
var _user$project$Modules_User$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoOp':
			...
			case 'SubmitLogin':
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: A3(_user$project$Modules_User$login, model.socketUrl, model.email, model.password),
							_1: {ctor: '[]'}
						})
				};
			case 'SubmitRegister':
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: A3(_user$project$Modules_User$register, model.socketUrl, model.email, model.password),
							_1: {ctor: '[]'}
						})
				};
			case 'LoginSuccess':
...
var _user$project$Modules_User$SubmitRegister = {ctor: 'SubmitRegister'};
var _user$project$Modules_User$SubmitLogin = {ctor: 'SubmitLogin'};
var _user$project$Modules_User$UpdateEmail = function (a) {
	return {ctor: 'UpdateEmail', _0: a};
};
var _user$project$Modules_User$UpdatePasswordConfirmation = function (a) {
	return {ctor: 'UpdatePasswordConfirmation', _0: a};
};
var _user$project$Modules_User$UpdatePassword = function (a) {
	return {ctor: 'UpdatePassword', _0: a};
};
var _user$project$Modules_User$loginView = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Modules_User$SubmitLogin),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Modules_User$UpdateEmail),
								_1: {
									ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Modules_User$UpdatePassword),
									_1: {
										ctor: '::',
...
var _user$project$Modules_User$registerView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Modules_User$SubmitRegister),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Modules_User$UpdatePasswordConfirmation),
										_1: {
											ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_user$project$Components_Atoms_Button$button,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('user__register__button'),
											_1: {ctor: '[]'}
										}
									},
									{
...
var _user$project$Types$Model = F3(
	function (a, b, c) {
		return {userModel: a, route: b, flags: c};
	});
var _user$project$Types$Flags = function (a) {
	return {socketUrl: a};
};
var _user$project$Types$PingError = function (a) {
	return {ctor: 'PingError', _0: a};
};
var _user$project$Types$PingSuccess = function (a) {
	return {ctor: 'PingSuccess', _0: a};
};
...
var _user$project$Commands$ping = function (socketUrl) {
	var payload = _elm_lang$core$Json_Encode$object(
		{ctor: '[]'});
	var push = A2(
		_saschatimme$elm_phoenix$Phoenix_Push$onError,
		_user$project$Types$PingError,
		A2(
			_saschatimme$elm_phoenix$Phoenix_Push$onOk,
			_user$project$Types$PingSuccess,
			A2(
				_saschatimme$elm_phoenix$Phoenix_Push$withPayload,
				payload,
				A2(_saschatimme$elm_phoenix$Phoenix_Push$init, 'room', 'room:ping'))));
	return A2(_saschatimme$elm_phoenix$Phoenix$push, socketUrl, push);
};

var _user$project$Components_Molecules_Navigation$navigation = function (routes) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_user$project$Components_Atoms_Button$button,
					{
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Types$NavigateTo(
								_elm_lang$core$Tuple$first(route))),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Tuple$second(route)),
						_1: {ctor: '[]'}
					});
			},
			routes));
...
var _user$project$Subscriptions$contacts = _saschatimme$elm_phoenix$Phoenix_Channel$withDebug(
	_saschatimme$elm_phoenix$Phoenix_Channel$init('room'));
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Noop':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'UrlChange':
				var currentRoute = _user$project$Routing$parse(_p0._0);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$Commands$ping(model.flags.socketUrl),
								_1: {ctor: '[]'}
							}
						})
				};
			case 'UserMsg':
				var _p1 = A2(_user$project$Modules_User$update, _p0._0, model.userModel);
				...
				return {
					...
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Types$UserMsg, cmd)
				};
			case 'PingSuccess':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
...
var _user$project$View$navigationItems = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: _user$project$Routing$IndexRoute, _1: 'Home'},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: _user$project$Routing$LoginRoute, _1: 'Login'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _user$project$Routing$RegisterRoute, _1: 'Register'},
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Components_Molecules_Navigation$navigation(_user$project$View$navigationItems),
			_1: {
				ctor: '::',
				_0: function () {
					var _p0 = model.route;
							...
							return A2(
								_elm_lang$html$Html$div,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Types$NavigateTo(_user$project$Routing$RegisterRoute)),
										_1: {ctor: '[]'}
									}
								},
								{
							...
							return A2(
								...
								},
								{
									...
									_0: A2(
										...
										_user$project$Types$UserMsg,
										_user$project$Modules_User$loginView(model.userModel)),
									_1: {ctor: '[]'}
								});
						case 'RegisterRoute':
							return A2(
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$map,
										_user$project$Types$UserMsg,
										_user$project$Modules_User$registerView(model.userModel)),
									_1: {ctor: '[]'}
								});
						default:
							return A2(
...
var _user$project$Main$initialModel = F2(
	function (flags, route) {
		return {
			ctor: '_Tuple2',
			_0: {
				userModel: _user$project$Modules_User$initialModel(flags.socketUrl),
				route: route,
				flags: flags
			},
			_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$Main$init = F2(
	function (flags, location) {
		...
		return A2(_user$project$Main$initialModel, flags, currentRoute);
	});
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Routing.Route":{"args":[],"tags":{"IndexRoute":[],"LoginRoute":[],"NotFoundRoute":[],"RegisterRoute":[]}},"Types.Msg":{"args":[],"tags":{"PingError":["Json.Encode.Value"],"PingSuccess":["Json.Encode.Value"],"NavigateTo":["Routing.Route"],"UrlChange":["Navigation.Location"],"UserMsg":["Modules.User.Msg"],"Noop":[]}},"Modules.User.Msg":{"args":[],"tags":{"SubmitLogin":[],"UpdateEmail":["String"],"LoginSuccess":["Json.Encode.Value"],"LoginError":["Json.Encode.Value"],"RegisterSuccess":["Json.Encode.Value"],"SubmitRegister":[],"NoOp":[],"UpdatePassword":["String"],"UpdatePasswordConfirmation":["String"],"RegisterError":["Json.Encode.Value"]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Types.Msg"},"versions":{"elm":"0.18.0"}});
}
