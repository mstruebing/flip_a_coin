...
var _user$project$Types$FlipError = function (a) {
	return {ctor: 'FlipError', _0: a};
};
var _user$project$Types$FlipSuccess = function (a) {
	return {ctor: 'FlipSuccess', _0: a};
};
var _user$project$Types$Flip = {ctor: 'Flip'};

var _user$project$Commands$flip = function (socketUrl) {
	var payload = _elm_lang$core$Json_Encode$object(
		{ctor: '[]'});
	var push = A2(
		_saschatimme$elm_phoenix$Phoenix_Push$onError,
		_user$project$Types$FlipError,
		A2(
			_saschatimme$elm_phoenix$Phoenix_Push$onOk,
			_user$project$Types$FlipSuccess,
			A2(
				_saschatimme$elm_phoenix$Phoenix_Push$withPayload,
				payload,
				A2(_saschatimme$elm_phoenix$Phoenix_Push$init, 'flip_a_coin', 'flip'))));
...
var _user$project$Subscriptions$contacts = _saschatimme$elm_phoenix$Phoenix_Channel$withDebug(
	_saschatimme$elm_phoenix$Phoenix_Channel$init('flip_a_coin'));
		...
		switch (_p0.ctor) {
			case 'Flip':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Commands$flip(model.flags.socketUrl)
				};
			case 'FlipSuccess':
				var x = A2(_elm_lang$core$Debug$log, 'message', _p0._0);
...
var _user$project$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$Flip),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(model.coinStatus)),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$initialModel = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {flags: flags, coinStatus: _user$project$Types$Head},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$Main$init = function (flags) {
	return _user$project$Main$initialModel(flags);
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Types.Msg":{"args":[],"tags":{"Flip":[],"FlipSuccess":["Json.Encode.Value"],"FlipError":["Json.Encode.Value"]}}},"aliases":{},"message":"Types.Msg"},"versions":{"elm":"0.18.0"}});
}
